...
-- Step 1 & 2: Prepare source data and expire old records if 'czy_nowy' changed
...
FROM SCD_test.dbo.Klient_D dwh 
...
INSERT INTO SCD_test.dbo.Klient_D (pesel_klienta, czy_nowy, data_wpisania, data_wygasniecia)
SELECT 
    sc.client_pesel,
    sc.czy_nowy,
...
LEFT JOIN SCD_test.dbo.Klient_D dwh
