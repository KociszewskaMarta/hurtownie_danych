...
INSERT INTO Wycieczka_D
    (nazwa_wycieczki, destynacja, typ)
VALUES
...
INSERT INTO Klient_D
    (pesel_klienta, czy_nowy, data_wpisania, data_wygasniecia)
VALUES
    ('90010112345', 'Tak', '2024-03-01', NULL),
    ('85050567890', 'Nie', '2022-10-12', NULL),
    ('92031255555', 'Tak', '2024-11-20', NULL);

INSERT INTO Slowo_kluczowe_D
    (slowo_kluczowe)
VALUES
    ('wakacje Hiszpania'),
    ('last minute'),
